...
Currently Keplr provides only Alpha support for GRAV tokens. As a result, Keplr is missing many common features (e.g. staking, transfer, IBC transfer, and proper display of token balance and IBC token inventory). <br><br>
